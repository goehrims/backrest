...
func (x *SnapshotDiffResponse) Reset() {
	*x = SnapshotDiffResponse{}
	mi := &file_v1_service_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SnapshotDiffResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SnapshotDiffResponse) ProtoMessage() {}

func (x *SnapshotDiffResponse) ProtoReflect() protoreflect.Message {
	mi := &file_v1_service_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SnapshotDiffResponse.ProtoReflect.Descriptor instead.
func (*SnapshotDiffResponse) Descriptor() ([]byte, []int) {
	return file_v1_service_proto_rawDescGZIP(), []int{17}
}

func (x *SnapshotDiffResponse) GetEntries() []*DiffEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
func (x *DiffEntry) GetChangeType() string {
	if x != nil {
		return x.ChangeType
	}
	return ""
...
const file_v1_service_proto_rawDesc = "" +
	...
	"\x0eto_snapshot_id\x18\x03 \x01(\tR\ftoSnapshotId\"?\n" +
	"\x14SnapshotDiffResponse\x12'\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token2\xcb\v\n" +
	"\bBackrest\x121\n" +
	...
	"\x11ListSnapshotFiles\x12\x1c.v1.ListSnapshotFilesRequest\x1a\x1d.v1.ListSnapshotFilesResponse\"\x00\x12D\n" +
	"\rDiffSnapshots\x12\x17.v1.SnapshotDiffRequest\x1a\x18.v1.SnapshotDiffResponse\"\x00\x125\n" +
...
var file_v1_service_proto_goTypes = []any{
	...
	(*SnapshotDiffRequest)(nil),                      // 17: v1.SnapshotDiffRequest
	(*SnapshotDiffResponse)(nil),                     // 18: v1.SnapshotDiffResponse
	(*DiffEntry)(nil),                                // 19: v1.DiffEntry
	(*LogDataRequest)(nil),                           // 20: v1.LogDataRequest
	(*GetDownloadURLRequest)(nil),                    // 21: v1.GetDownloadURLRequest
	(*LsEntry)(nil),                                  // 22: v1.LsEntry
	(*RunCommandRequest)(nil),                        // 23: v1.RunCommandRequest
	(*RunCommandResponse)(nil),                       // 24: v1.RunCommandResponse
	(*RemoveRepoRequest)(nil),                        // 25: v1.RemoveRepoRequest
	(*CancelOperationRequest)(nil),                   // 26: v1.CancelOperationRequest
	(*SummaryDashboardResponse)(nil),                 // 27: v1.SummaryDashboardResponse
	(*GeneratePairingTokenRequest)(nil),              // 28: v1.GeneratePairingTokenRequest
	(*GeneratePairingTokenResponse)(nil),             // 29: v1.GeneratePairingTokenResponse
	(*SummaryDashboardResponse_Summary)(nil),         // 30: v1.SummaryDashboardResponse.Summary
	(*SummaryDashboardResponse_BackupChart)(nil),     // 31: v1.SummaryDashboardResponse.BackupChart
	(*SummaryDashboardResponse_DayStatusBucket)(nil), // 32: v1.SummaryDashboardResponse.DayStatusBucket
	(*SummaryDashboardResponse_StatusAndCount)(nil),  // 33: v1.SummaryDashboardResponse.StatusAndCount
	(*Repo)(nil),                                     // 34: v1.Repo
	(*Multihost_Permission)(nil),                     // 35: v1.Multihost.Permission
	(OperationStatus)(0),                             // 36: v1.OperationStatus
	(*emptypb.Empty)(nil),                            // 37: google.protobuf.Empty
	(*Config)(nil),                                   // 38: v1.Config
	(*types.StringValue)(nil),                        // 39: types.StringValue
	(*OperationEvent)(nil),                           // 40: v1.OperationEvent
	(*OperationList)(nil),                            // 41: v1.OperationList
	(*ResticSnapshotList)(nil),                       // 42: v1.ResticSnapshotList
	(*types.BytesValue)(nil),                         // 43: types.BytesValue
	(*types.StringList)(nil),                         // 44: types.StringList
}
var file_v1_service_proto_depIdxs = []int32{
	34, // 0: v1.CheckRepoExistsRequest.repo:type_name -> v1.Repo
	34, // 1: v1.AddRepoRequest.repo:type_name -> v1.Repo
	...
	22, // 5: v1.ListSnapshotFilesResponse.entries:type_name -> v1.LsEntry
	19, // 6: v1.SnapshotDiffResponse.entries:type_name -> v1.DiffEntry
	30, // 7: v1.SummaryDashboardResponse.repo_summaries:type_name -> v1.SummaryDashboardResponse.Summary
	30, // 8: v1.SummaryDashboardResponse.plan_summaries:type_name -> v1.SummaryDashboardResponse.Summary
	35, // 9: v1.GeneratePairingTokenRequest.permissions:type_name -> v1.Multihost.Permission
	31, // 10: v1.SummaryDashboardResponse.Summary.recent_backups:type_name -> v1.SummaryDashboardResponse.BackupChart
	32, // 11: v1.SummaryDashboardResponse.Summary.history_last_30days:type_name -> v1.SummaryDashboardResponse.DayStatusBucket
	36, // 12: v1.SummaryDashboardResponse.BackupChart.status:type_name -> v1.OperationStatus
	33, // 13: v1.SummaryDashboardResponse.DayStatusBucket.status_counts:type_name -> v1.SummaryDashboardResponse.StatusAndCount
	36, // 14: v1.SummaryDashboardResponse.StatusAndCount.status:type_name -> v1.OperationStatus
	37, // 15: v1.Backrest.GetConfig:input_type -> google.protobuf.Empty
	38, // 16: v1.Backrest.SetConfig:input_type -> v1.Config
	4,  // 17: v1.Backrest.SetupSftp:input_type -> v1.SetupSftpRequest
	6,  // 18: v1.Backrest.CheckRepoExists:input_type -> v1.CheckRepoExistsRequest
	8,  // 19: v1.Backrest.AddRepo:input_type -> v1.AddRepoRequest
	25, // 20: v1.Backrest.RemoveRepo:input_type -> v1.RemoveRepoRequest
	37, // 21: v1.Backrest.GetOperationEvents:input_type -> google.protobuf.Empty
	13, // 22: v1.Backrest.GetOperations:input_type -> v1.GetOperationsRequest
	12, // 23: v1.Backrest.ListSnapshots:input_type -> v1.ListSnapshotsRequest
	15, // 24: v1.Backrest.ListSnapshotFiles:input_type -> v1.ListSnapshotFilesRequest
	17, // 25: v1.Backrest.DiffSnapshots:input_type -> v1.SnapshotDiffRequest
	1,  // 26: v1.Backrest.Backup:input_type -> v1.BackupRequest
	9,  // 27: v1.Backrest.DoRepoTask:input_type -> v1.DoRepoTaskRequest
	11, // 28: v1.Backrest.Forget:input_type -> v1.ForgetRequest
	14, // 29: v1.Backrest.Restore:input_type -> v1.RestoreSnapshotRequest
	26, // 30: v1.Backrest.Cancel:input_type -> v1.CancelOperationRequest
	20, // 31: v1.Backrest.GetLogs:input_type -> v1.LogDataRequest
	23, // 32: v1.Backrest.RunCommand:input_type -> v1.RunCommandRequest
	21, // 33: v1.Backrest.GetDownloadURL:input_type -> v1.GetDownloadURLRequest
	10, // 34: v1.Backrest.ClearHistory:input_type -> v1.ClearHistoryRequest
	39, // 35: v1.Backrest.PathAutocomplete:input_type -> types.StringValue
	37, // 36: v1.Backrest.GetSummaryDashboard:input_type -> google.protobuf.Empty
	28, // 37: v1.Backrest.GeneratePairingToken:input_type -> v1.GeneratePairingTokenRequest
	38, // 38: v1.Backrest.GetConfig:output_type -> v1.Config
	38, // 39: v1.Backrest.SetConfig:output_type -> v1.Config
	5,  // 40: v1.Backrest.SetupSftp:output_type -> v1.SetupSftpResponse
	7,  // 41: v1.Backrest.CheckRepoExists:output_type -> v1.CheckRepoExistsResponse
	38, // 42: v1.Backrest.AddRepo:output_type -> v1.Config
	38, // 43: v1.Backrest.RemoveRepo:output_type -> v1.Config
	40, // 44: v1.Backrest.GetOperationEvents:output_type -> v1.OperationEvent
	41, // 45: v1.Backrest.GetOperations:output_type -> v1.OperationList
	42, // 46: v1.Backrest.ListSnapshots:output_type -> v1.ResticSnapshotList
	16, // 47: v1.Backrest.ListSnapshotFiles:output_type -> v1.ListSnapshotFilesResponse
	18, // 48: v1.Backrest.DiffSnapshots:output_type -> v1.SnapshotDiffResponse
	37, // 49: v1.Backrest.Backup:output_type -> google.protobuf.Empty
	2,  // 50: v1.Backrest.DoRepoTask:output_type -> v1.ScheduleTaskResponse
	2,  // 51: v1.Backrest.Forget:output_type -> v1.ScheduleTaskResponse
	2,  // 52: v1.Backrest.Restore:output_type -> v1.ScheduleTaskResponse
	37, // 53: v1.Backrest.Cancel:output_type -> google.protobuf.Empty
	43, // 54: v1.Backrest.GetLogs:output_type -> types.BytesValue
	24, // 55: v1.Backrest.RunCommand:output_type -> v1.RunCommandResponse
	39, // 56: v1.Backrest.GetDownloadURL:output_type -> types.StringValue
	37, // 57: v1.Backrest.ClearHistory:output_type -> google.protobuf.Empty
	44, // 58: v1.Backrest.PathAutocomplete:output_type -> types.StringList
	27, // 59: v1.Backrest.GetSummaryDashboard:output_type -> v1.SummaryDashboardResponse
	29, // 60: v1.Backrest.GeneratePairingToken:output_type -> v1.GeneratePairingTokenResponse
