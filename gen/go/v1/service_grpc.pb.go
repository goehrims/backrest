...
const (
	...
	Backrest_DiffSnapshots_FullMethodName        = "/v1.Backrest/DiffSnapshots"
...
type BackrestClient interface {
	...
	DiffSnapshots(ctx context.Context, in *SnapshotDiffRequest, opts ...grpc.CallOption) (*SnapshotDiffResponse, error)
...
func (c *backrestClient) DiffSnapshots(ctx context.Context, in *SnapshotDiffRequest, opts ...grpc.CallOption) (*SnapshotDiffResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SnapshotDiffResponse)
	err := c.cc.Invoke(ctx, Backrest_DiffSnapshots_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackrestServer interface {
	...
	DiffSnapshots(context.Context, *SnapshotDiffRequest) (*SnapshotDiffResponse, error)
	// Backup schedules a backup operation. It accepts a plan id and returns empty if the task is enqueued.
...
func (UnimplementedBackrestServer) DiffSnapshots(context.Context, *SnapshotDiffRequest) (*SnapshotDiffResponse, error) {
...
func _Backrest_DiffSnapshots_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SnapshotDiffRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackrestServer).DiffSnapshots(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Backrest_DiffSnapshots_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackrestServer).DiffSnapshots(ctx, req.(*SnapshotDiffRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Backrest_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Backrest_DiffSnapshots_Handler,
		},
		{
			MethodName: "Backup",
